    ...
    const TagContent = (props) => {
        ...
        if (tag === "/") {
            ...
            return (_jsxs("div", { class: "popover-hint", children: [_jsx("article", { class: classes, children: _jsx("p", { children: content }) }), _jsx("p", { children: i18n(cfg.locale).pages.tagContent.totalTags({ count: tags.length }) }), _jsx("div", { children: tags.map((tag) => {
                            ...
                            return (_jsxs("div", { children: [_jsx("h2", { children: _jsx("a", { class: "internal tag-link", href: `../tags/${tag}`, children: tag }) }), content && _jsx("p", { children: content }), _jsxs("div", { class: "page-listing", children: [_jsxs("p", { children: [i18n(cfg.locale).pages.tagContent.itemsUnderTag({ count: pages.length }), pages.length > options.numPages && (_jsxs(_Fragment, { children: [" ", _jsx("span", { children: i18n(cfg.locale).pages.tagContent.showingFirst({
                                                                    count: options.numPages,
                                                                }) })] }))] }), _jsx(PageList, { limit: options.numPages, ...listProps, sort: opts?.sort })] })] }));
                        }) })] }));
        }
        else {
